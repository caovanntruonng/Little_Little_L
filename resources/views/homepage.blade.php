    ...
    <div class="background">
        <div class="homepage">
            ...
            <div class="home-form-container">
                ...
                <div class="form px-3">
                    <form action="{{ route('payment.show') }}" method="POST" class="text-center">
                        @csrf
                        <div class="package d-flex">
                            <select name="type" id="">
                                @foreach ($tickets as $ticket)
                                <option value="{{$ticket->type}}" class="select-option">{{$ticket->type}}</option>
                                @endforeach
                        ...
                        <div class="tickets d-flex justify-content-between">
                            <input type="number" name="ticketnumber" id="" placeholder="Số lượng vé"
...
@if ($errors->any())
@include('notification.homefailed')
<script>
