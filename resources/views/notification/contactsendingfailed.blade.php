    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{-- lỗi tên --}}
                @if ($errors->has('name'))
                <div class="text-danger">Vui lòng điền vào trường Tên.</div>
                @endif
                ...
                <div class="text-danger">Vui lòng điền vào trường Địa chỉ.</div>
                @endif

                {{-- lỗi lời nhắn --}}
                @if ($errors->has('message'))
                <div class="text-danger">Vui lòng nhập lời nhắn.</div>
                @endif
            </div>
